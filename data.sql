...
INSERT INTO incidents (id, server_id, service_id, priority_id, title, detected_at, resolved_at) VALUES
    ...
    (7, 13, 14, 3, 'ML-пайплайн: задача обучения модели зависла в очереди', '2026-04-08 15:45:00', NULL),
    (8, 18, 19, 2, 'CI/CD агенты: увеличение времени сборки', '2026-04-10 15:40:00', NULL),
    (9, 20, 21, 1, 'CRM: падение после планового обновления ОС', '2026-04-12 04:00:00', NULL),
    ...
    (16, 14, 15, 3, 'VPN-шлюз: периодическая потеря пакетов', '2026-05-06 18:15:00', NULL),
    (17, 15, 16, 1, 'CDN: задержка прогрева кэша после деплоя', '2026-05-08 09:45:00', '2026-05-08 10:05:00'),
    (18, 19, 20, 4, 'DR: разрыв канала асинхронной репликации', '2026-05-09 23:40:00', '2026-05-10 00:08:00');
