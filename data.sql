...
INSERT INTO incidents (id, server_id, service_id, priority_id, title, detected_at, resolved_at) VALUES
    (1, 8, 8, 3, 'Redis node is unavailable', '2026-01-05 07:10:00', NULL),
    (2, 4, 4, 2, 'Increased HTTP 5xx responses', '2026-02-01 12:05:00', '2026-02-01 13:20:00'),
    (3, 5, 5, 4, 'Primary database latency spike', '2026-03-03 02:15:00', '2026-03-03 02:42:00'),
    (4, 6, 6, 3, 'Replica lag exceeded threshold', '2026-03-03 02:20:00', '2026-03-03 03:10:00'),
    (5, 10, 11, 2, 'Log ingestion delay', '2026-03-18 11:30:00', '2026-03-18 12:05:00'),
    (6, 12, 13, 4, 'GPU inference endpoint timeout', '2026-04-06 09:00:00', '2026-04-06 09:18:00'),
    (7, 13, 14, 3, 'Training queue stalled', '2026-04-08 15:45:00', NULL),
    (8, 18, 19, 2, 'Build agents responding slowly', '2026-04-10 15:40:00', NULL),
    (9, 20, 21, 1, 'Legacy CRM stopped after patch window', '2026-04-12 04:00:00', NULL),
    (10, 1, 1, 2, 'Billing API error rate above baseline', '2026-04-20 10:25:00', '2026-04-20 10:55:00'),
    (11, 2, 2, 1, 'Worker queue backlog increased', '2026-04-22 13:10:00', '2026-04-22 14:00:00'),
    (12, 3, 3, 2, 'Portal TLS certificate warning', '2026-04-25 08:35:00', '2026-04-25 09:05:00'),
    (13, 7, 7, 3, 'Cache memory pressure', '2026-04-29 21:00:00', '2026-04-29 21:32:00'),
    (14, 9, 9, 1, 'Prometheus scrape gaps', '2026-05-02 06:10:00', '2026-05-02 06:25:00'),
    (15, 11, 12, 2, 'Backup job retry threshold reached', '2026-05-03 02:30:00', '2026-05-03 03:25:00'),
    (16, 14, 15, 3, 'VPN packet loss above SLA', '2026-05-06 18:15:00', NULL),
    (17, 15, 16, 1, 'CDN cache warm-up delay', '2026-05-08 09:45:00', '2026-05-08 10:05:00'),
    (18, 19, 20, 4, 'DR replication channel interrupted', '2026-05-09 23:40:00', '2026-05-10 00:08:00');

INSERT INTO maintenance_log (id, server_id, task_type, performed_at, description, downtime_minutes) VALUES
    (1, 1, 'OS_PATCH', '2026-01-12 01:00:00', 'Security patch installation', 12),
    (2, 2, 'OS_PATCH', '2026-01-12 01:30:00', 'Security patch installation', 10),
    (3, 3, 'FIRMWARE_UPDATE', '2026-01-19 02:00:00', 'NIC firmware update', 25),
    (4, 4, 'DIAGNOSTICS', '2026-02-01 13:30:00', 'Network diagnostics after HTTP errors', 35),
    (5, 5, 'STORAGE_CHECK', '2026-03-03 03:00:00', 'NVMe health check', 18),
    (6, 6, 'REPLICATION_CHECK', '2026-03-03 03:15:00', 'Replication lag investigation', 20),
    (7, 7, 'RAM_UPGRADE', '2026-03-20 01:00:00', 'Memory module replacement', 45),
    (8, 8, 'HARDWARE_REPAIR', '2026-01-05 08:00:00', 'Power supply replacement', 90),
    (9, 9, 'OS_PATCH', '2026-04-01 00:30:00', 'Monitoring stack patching', 8),
    (10, 10, 'DISK_EXPANSION', '2026-04-21 06:00:00', 'Log volume expansion', 22),
    (11, 11, 'BACKUP_TEST', '2026-04-30 03:00:00', 'Restore verification', 0),
    (12, 12, 'GPU_DRIVER_UPDATE', '2026-04-06 09:30:00', 'NVIDIA driver update', 30),
    (13, 13, 'GPU_DIAGNOSTICS', '2026-04-08 16:15:00', 'Training queue diagnostics', 40),
    (14, 14, 'NETWORK_CHECK', '2026-05-06 19:00:00', 'VPN routing inspection', 15),
    (15, 15, 'CACHE_RESTART', '2026-05-08 10:00:00', 'Cache service restart', 5),
    (16, 16, 'OS_PATCH', '2026-05-08 10:30:00', 'Edge node patching', 7),
    (17, 18, 'CI_AGENT_REPAIR', '2026-04-10 16:00:00', 'Runner cleanup and restart', 28),
    (18, 19, 'DR_TEST', '2026-05-10 00:15:00', 'Replication failover drill', 32);
